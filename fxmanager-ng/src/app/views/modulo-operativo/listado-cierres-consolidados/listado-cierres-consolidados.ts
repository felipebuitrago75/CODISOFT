...
@Component({
  templateUrl: './listado-cierres-consolidados.html'
})
export class ListaCierresConsolidadoComponent extends BaseScreenComponent<any> implements OnInit {
  ...
  public filaPygValPrecierreAcumulada : Array<any> = [];

  public filaPygValCierreDiario : Array<any> = [];
  public filaPygValCierreAcumulada : Array<any> = [];
  ...
  public buscarConFiltroL() {
    ...
    this.filaPygValPrecierreAcumulada=[];

    this.filaPygValCierreDiario=[];
    this.filaPygValCierreAcumulada=[];
    ...
    if ( !this.fechaFiltro) {
      ...
      this._cierreService.obtenerCierresConsolidadoPorFecha(this.fechaFiltro).subscribe(data => {
        data.forEach(element => {
          this.cierre = element;
          ...
          this.filaPYGCajaDiaria.push(this.cierre.utilidadDiaria);
          ...
          this.filaPygValPrecierreAcumulada.push(this.cierre.pygValPrecierreAcumulada);

          this.filaPygValCierreDiario.push(this.cierre.pygValCierreDiaria);
          this.filaPygValCierreAcumulada.push(this.cierre.pygValCierreAcumulada);
