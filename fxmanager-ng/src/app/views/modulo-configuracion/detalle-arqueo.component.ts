...
export class DetalleArqueoComponent extends BaseCrudFormComponent<any> implements OnInit {
    ...
    protected loadBean(id: any) {
        this._cierreTurnoService.arqueosHistoricosId(id).subscribe(data => {
            this.precierre = data;
            this.precierre.listaItems.forEach(element => {
                ...
                this.filaSaldosReales.push(element.saldosRealEnCaja);
        ...
        console.log(this.filaSaldosDiferencia);
    }
    ...
    public volver(){
        this.router.navigate(["lista-arqueos"]);
    }
    public clean() { }
