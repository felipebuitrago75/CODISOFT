...
@Component({
  templateUrl: './reporte-estado-actual.html'
})
export class ReporteEstadoActualComponent extends BaseScreenComponent<any> implements OnInit {
  ...
  public buscarConFiltro() {
    ...
    this._fxService.getFxs(0, 20).subscribe(fxs => {
      ...
      this._cierreService.reporteEstadoActual().subscribe(data => {
